...
@section('content')
    <div class="grid col-span-full">
        ...
        <div class="flex flex-col">
            ...
            @error('name') <div class="text-rose-600">{{ $message }}</div> @enderror
            <div class="mt-2">
            ...
            @error('status_id') <div class="text-rose-600">{{ $message }}</div> @enderror
            <div class="mt-2">
            ...
            <div class="mt-2">
                {{ Form::label('labels', __('tasks.edit.labels.labels')) }}
            </div>
            <div>
                {{ Form::select('labels', $labels->pluck('name', 'id'), null, ['class' => 'rounded border-gray-300 w-1/3 h-32', 'name' => 'labels[]', 'multiple' => 'multiple', 'placeholder' => '']) }}
            </div>
            <div class="mt-2">
