        ...
        <table class="mt-4">
            ...
            @foreach($tasks as $task)
                <tr class="border-b border-dashed text-left">
                    ...
                    <td>
                        @can('delete', $task)
                            <a href="{{ route('tasks.destroy', $task) }}" data-confirm="{{ __('tasks.index.delete_confirmation') }}" data-method="delete" class="text-red-600 hover:text-red-900">
